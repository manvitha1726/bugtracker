...
export const fetchEmployees = createAsyncThunk(
    ...
    async (args, {rejectWithValue}) => {
        try{
            const response = await fetch("https://issueapp.azurewebsites.net/api/issue/getallemployees");
    ...
    async (employeeId, {rejectWithValue}) => {
        try{
            const response = await fetch(
                `https://issueapp.azurewebsites.net/api/issue/getemployeebyid?empid=${employeeId}`
            );
            const result = await response.json();
            return result;
        }
...
export const addEmployees = createAsyncThunk(
    ...
    try{
        ...
        const response = fetch(`https://issueapp.azurewebsites.net/api/issue/addemployee`, {  
          method: 'POST', 
          headers: {
